      ...
      <div className="bg-linear-to-r from-violet-600 to-indigo-600 md:p-24 py-20 text-center text-white shadow-2xl relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-4">
            <button className="w-50 py-4 bg-white text-violet-600 rounded-full font-semibold text-lg hover:bg-violet-200/90 cursor-pointer transition-all duration-300 shadow-xl shadow-black/10">
              Explore Products
            </button>
            <button className="w-50 py-4 bg-transparent border-2 border-white/50 text-white rounded-full font-semibold text-lg hover:bg-white hover:text-violet-600 transition-all duration-300 cursor-pointer">
              View Pricing
            </button>
          </div>
