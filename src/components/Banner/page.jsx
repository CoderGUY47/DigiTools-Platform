    ...
    <div className="relative min-h-162.5 flex items-center overflow-hidden w-[80%] mx-auto">
        ...
        <div className="relative mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center space-y-4">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-6xl max-w-xl font-semibold text-gray-900 mb-6 mt-3">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <button className="group flex items-center gap-2 px-8 py-3 rounded-full font-semibold border-2 border-violet-600 hover:bg-linear-to-r hover:from-violet-600 hover:to-indigo-600 shadow-sm hover:shadow-md transition-all duration-300">
